...
<div class="container" style="color: #0066ff ;">
    <h3>
        LISTE DES PARTICIPANTS DU CHAMPIONAT : <?=championat($_GET['id'])['nom_championat']?>
    </h3><hr>
    <?php
        $compt = 1 ;
    ?>
    ...
    <table class="table table-responsive table-striped table-hover">
        ...
        <tbody>
            ...
            <?php
        $coureur_championats = get_all_coureur_championat($_GET['id']);
        ...
        ?>
            <tr>
                ...
                <td>
                    <?= $coureur['date_inscription']?>
                </td>

                <td>
                    <?= nom_equipe(get_player_team($coureur['id_coureur']))?>
                </td>
                ...
                <td>
                    ...
                    ?>
                    <button
                        onclick="window.location = '../controleurs/udate_status.php?id=<?=$coureur['id_coureur']."/".$_GET['id']."/".$status?>';"
