<div id="update_sp<?=$sp['id']?>" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Modifier SP</h4>
            </div>
            <form class="form-inline" action="../controleurs/update_sp.php?id=<?=$_GET['id']?>" method="post">
                <div class="modal-body">
                 ...
                 <div class="row">
                        ...
                        <input type="hidden" name="top3" value="<?=$sp['id']?>">
                        <div class="col-lg-1">
